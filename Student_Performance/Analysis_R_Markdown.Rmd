---
title: "Statistical Analysis - Student Performance Dataset"
...
## Binary Variables: Paid Extra Classes, Higher Education Aspiration, Internet Access
...
## Ordinal Variables: Mother's Education (Medu) and Family Relationship (Famrel)
...
## G3 vs Wish For Higher Education
...
## Family Relationship vs Age

```{r melisa-rebellion-combined, fig.width=9, fig.height=3, fig.pos='H', fig.cap="Family Relationship vs Age: Statistics (left) and Heatmap (right)"}
# 1. Prepare Stats
age_famrel_stats <- df %>% 
  group_by(age) %>% 
  summarise(
...
## Simple Linear Regression G3~Absences
...
This document acknowledges the use of AI software in the following aspects of the analysis:

* **Data Visualization:** AI assistance was utilized for creating and formatting the statistical visualizations throughout this document, including the implementation of side-by-side plot arrangements using `grid.arrange()` and `gridExtra` functions.

* **Introduction Enhancement:** The introduction section was enhanced with AI assistance to improve clarity, structure, and academic writing quality.

* **Markdown Formatting:** AI software was used to assist with R Markdown formatting, including code chunk organization, figure placement, and document structure.

All statistical analyses, interpretations, and conclusions presented in this document remain the responsibility of the authors.
