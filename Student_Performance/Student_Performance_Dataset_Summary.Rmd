...
data <- read_csv2("/Users/melisacihan/Desktop/Statistical Computing/StatsProj/Student_Performance/student-mat.csv")
...
```
### **dimension of selected subset**
```{r dims selected data}
dim(data_selected)
```
